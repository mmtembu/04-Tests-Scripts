...
//   console.log(ballotContract)
  const getProposals = await ballotContract.proposals(0);
//   for(let i = 0; i <getProposals.length; i++)
    console.log(getProposals.name);
//   console.log(ethers.utils.parseBytes32String(await ballotContract.winnerName()));
}
